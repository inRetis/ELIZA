...
var elizaInitials = [
  `=================================<br>
                  ELIZA psicoterapeuta virtuale del 1966<br>
  =================================<br>
   ...
   Tradotto e adattato in italiano, alla bene e meglio, da Mattia Berlini nel 2021.

<br><br>  Per saperne di più: <a href="https://it.wikipedia.org/wiki/ELIZA_(chatterbot)">https://it.wikipedia.org/wiki/ELIZA_(chatterbot)</a>
<br>Per vedere o scaricare il codice sorgente di ELIZA in italiano: <a href="https://github.com/inRetis/ELIZA-ITALIANO">https://github.com/inRetis/ELIZA-ITALIANO</a>
<br>Per un commento più o meno serio, c'è questo video: <a href="https://www.youtube.com/watch?v=YkSzFHPRsd4">https://www.youtube.com/watch?v=YkSzFHPRsd4</a>
<br><br>
Questo semplicissimo software in lingua italiana è distributo da me gratuitamente, e in open source. Questa è una semplice curiosità ma che purtroppo rende possibile un certo numero di business non proprio seri.
<br><br>
Per esempio, faccendo ricerche su google sono capitato su delle publicità di questo tipo:
<br>
<img src="terapia1.jpg" width="100%">
<br>
Oppure:
<br>
<img src="terapia2.jpg" width="100%">
<br><br>
Puoi provare Eliza qui sotto. Questa chat non registra alcun dato, una volta la pagina scaricata funziona anche senza connessione ad internet.
<br>Il tutto è elaborato all'interno del tuo navigatore.
<br><br>ELIZA > Ciao sono Eliza.`];
